...
<div class="navbar navbar-dark box-shadow">
            <div class="container d-flex justify-content-between"><a href="index.php"
                    class="navbar-brand logo_brand d-flex align-items-center"><img src="assets/images/programmation-web.png"
                        alt="شعار الموقع"></a>
                <ul class="list-inline m-0 visit-link hidden-on-small">
                    <li class="list-inline-item more-menu"><a href="request_price.php" class="nav-link">اطلب عرض
                            سعر</a></li>
                    <li class="list-inline-item more-menu"><a href="#" class="nav-link">طلب تقييم
                            فكرة</a></li>
        ...
        <div class="container form-request">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="contant-column">
                        <p class="text-center">+2162569845</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12"><label for="">رفع أي مرفقات من خلال النموذج أسفلهُ</label>
                    <form action="https://abdo-developer.github.io/file-upload" class="dropzone" id="my-awesome-dropzone"></form>
                </div>
